...
model.to('cuda')
model.module.load_checkpoint("./checkpoint/FB15K237/FB15K237_TransH.ckpt")
...
update_and_save_checkpoint(checkpoint_path="./checkpoint/FB15K237/FB15K237_TransH.ckpt", 
                           new_checkpoint_path="./checkpoint/FB15K237/GIF_Node_TransH_FB15K237.ckpt", 
...
# test the model
unlearn_transe.load_checkpoint("./checkpoint/FB15K237/GIF_Node_TransH_FB15K237.ckpt")
