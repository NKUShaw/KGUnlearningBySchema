...
trainer.run()
transd.save_checkpoint('./checkpoint/FB15K237/Retrain_Nodes_TransD_FB15K237.ckpt')

# test the model
transd.load_checkpoint('./checkpoint/FB15K237/Retrain_Nodes_TransD_FB15K237.ckpt')
