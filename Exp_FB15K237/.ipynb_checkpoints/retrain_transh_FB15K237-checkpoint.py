...
trainer.run()
transh.save_checkpoint('./checkpoint/FB15K237/Retrain_Nodes_TransH_FB15K237.ckpt')

# test the model
transh.load_checkpoint('./checkpoint/FB15K237/Retrain_Nodes_TransH_FB15K237.ckpt')
