...
model.to('cuda')
model.module.load_checkpoint("./checkpoint/FB15K237/FB15K237_TransE.ckpt")
...
params_esti = GIF_unleanring(model, train_dataloader, retrain_dataloader, iteration=500, damp=0.0, scale=1000)
update_and_save_checkpoint(checkpoint_path="./checkpoint/FB15K237/FB15K237_TransE.ckpt", 
                           new_checkpoint_path="./checkpoint/FB15K237/GIF_Node_TransE_FB15K237.ckpt", 
...
# test the model
unlearn_transe.load_checkpoint("./checkpoint/FB15K237/GIF_Node_TransE_FB15K237.ckpt")
