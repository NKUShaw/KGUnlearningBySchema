...
# train the model
transh.load_checkpoint('./checkpoint/FB15K237/FB15K237_TransH.ckpt')
trainer = Trainer(model = model, data_loader = train_dataloader, train_times = 100, alpha = 1e-4, use_gpu = True)
trainer.run_grad_ascent()
transh.save_checkpoint('./checkpoint/FB15K237/GradAscent_Nodes_TransH_FB15K237.ckpt')

# test the model
transh.load_checkpoint('./checkpoint/FB15K237/GradAscent_Nodes_TransH_FB15K237.ckpt')
