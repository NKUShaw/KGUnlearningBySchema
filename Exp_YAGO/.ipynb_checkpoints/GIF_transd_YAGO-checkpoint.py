...
model.to('cuda')
model.module.load_checkpoint("./checkpoint/YAGO/YAGO_TransD.ckpt")
...
update_and_save_checkpoint(checkpoint_path="./checkpoint/YAGO/YAGO_TransD.ckpt", 
                           new_checkpoint_path="./checkpoint/GIF_TransD_YAGO_0.1.ckpt", 
...
# test the model
unlearn_transe.load_checkpoint("./checkpoint/GIF_TransD_YAGO_0.1.ckpt")
