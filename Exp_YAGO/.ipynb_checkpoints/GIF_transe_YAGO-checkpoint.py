...
model.to('cuda')
model.module.load_checkpoint("./checkpoint/YAGO/YAGO_TransE.ckpt")
...
update_and_save_checkpoint(checkpoint_path="./checkpoint/YAGO/YAGO_TransE.ckpt", 
                           new_checkpoint_path="./checkpoint/YAGO/GIF_Nodes_TransE_YAGO.ckpt", 
...
# test the model
unlearn_transe.load_checkpoint("./checkpoint/YAGO/GIF_Nodes_TransE_YAGO.ckpt")
