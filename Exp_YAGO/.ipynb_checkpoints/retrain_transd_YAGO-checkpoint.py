...
trainer.run()
transd.save_checkpoint('./checkpoint/YAGO/Entity/Retrain_Node_TransD_YAGO.ckpt')

# test the model
transd.load_checkpoint('./checkpoint/YAGO/Entity/Retrain_Node_TransD_YAGO.ckpt')
