...
model.to('cuda')
model.module.load_checkpoint("./checkpoint/YAGO/YAGO_TransH.ckpt")
...
update_and_save_checkpoint(checkpoint_path="./checkpoint/YAGO/YAGO_TransH.ckpt", 
                           new_checkpoint_path="./checkpoint/GIF_TransH_YAGO_0.1.ckpt", 
...
# test the model
unlearn_transe.load_checkpoint("./checkpoint/GIF_TransH_YAGO_0.1.ckpt")
