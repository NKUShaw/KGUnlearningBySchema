...
# trainer.run()
# transe.save_checkpoint('./checkpoint/YAGO/Entity/Retrain_Node_TransE_YAGO.ckpt')

# test the model
transe.load_checkpoint('./checkpoint/YAGO/Entity/Retrain_Node_TransE_YAGO.ckpt')
