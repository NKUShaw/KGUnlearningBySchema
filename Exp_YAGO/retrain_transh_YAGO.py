...
# trainer.run()
# transh.save_checkpoint('./checkpoint/YAGO/Entity/Retrain_Node_TransH_YAGO.ckpt')

# test the model
transh.load_checkpoint('./checkpoint/YAGO/Entity/Retrain_Node_TransH_YAGO.ckpt')
